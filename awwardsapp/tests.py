...
class VoteTestClass(TestCase):
    def setUp(self):
        ...
        self.profile = Profile(user= self.carey, prof_pic='png',bio='bio', email='carey@gmail', link='www.profile.com')
        self.project = Project(author= "carey", project_title= "test", project_image = "imageurl", project_description ="test project", link = "testlink")
    ...
    def test_get_project_voters(self):
        ...
        self.assertEqual(voters[0].voter.user.username, 'carey')
